  ...
  return (
    <div className="flex flex-col flex-1 bg-stone-950 text-white">
      ...
      <main id="top" className="flex-1">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto grid max-w-6xl gap-12 px-6 py-20 sm:py-28 md:grid-cols-2 md:items-center">
            <div>
              ...
              <p className="mt-5 max-w-lg text-lg leading-8 text-stone-400">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <a
                  href="tel:9789214998"
                  className="inline-flex items-center gap-2 rounded-full border border-stone-700 bg-stone-900/60 px-6 py-3.5 text-sm font-semibold text-stone-200 backdrop-blur transition-colors hover:text-yellow-300"
                >
            ...
            <div className="relative">
              <div className="relative -rotate-2 aspect-[4/3] w-full overflow-hidden rounded-[2rem] border border-stone-800 bg-stone-900 shadow-2xl shadow-black/50">
                <Image
                  src="/landing.jpg"
              ...
              <span className="absolute -bottom-5 -left-5 flex items-center gap-2 rounded-2xl border border-stone-800 bg-stone-900 px-4 py-3 shadow-lg shadow-black/40">
          ...
          <div className="relative mx-auto mt-16 max-w-6xl px-6 pb-16 sm:pb-24">
            <div className="grid grid-cols-2 divide-y divide-stone-800 rounded-[2rem] border border-stone-800 bg-stone-900/80 shadow-lg shadow-black/30 backdrop-blur sm:grid-cols-4 sm:divide-x sm:divide-y-0">
          ...
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="relative mt-14 flex flex-col gap-10 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
              ...
              {[
                ...
                >
                  <span
                    className={`flex h-14 w-14 shrink-0 items-center justify-center rounded-full ring-4 ring-stone-950 transition-transform group-hover:scale-110 ${iconBadge}`}
                  >
                  ...
                  <p className="max-w-[15rem] text-sm leading-6 text-stone-400">
                    {desc}
                  </p>
                </div>
              ))}
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-x-8 gap-y-5">
              {subjects.map(({ name, icon: Icon }, i) => (
                <div key={name} className="flex items-center gap-4">
                  ...
                  {i < subjects.length - 1 && (
                    <span className="hidden h-1.5 w-1.5 rounded-full bg-stone-700 sm:block" aria-hidden />
                  )}
                </div>
              ))}
            </div>
            ...
            <p className="mx-auto mt-2 max-w-xl text-center text-sm text-stone-400">
            ...
            <div className="relative mt-8 -mx-6 overflow-hidden sm:mx-0">
              <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-16 bg-gradient-to-r from-stone-950 to-transparent" />
              <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-16 bg-gradient-to-l from-stone-950 to-transparent" />
              <div className="animate-marquee flex w-max gap-3 px-6">
                {[...activities, ...activities].map((activity, i) => (
                  <span
                    key={`${activity}-${i}`}
                    className="shrink-0 rounded-full bg-yellow-400 px-5 py-2.5 text-sm font-semibold text-stone-900 shadow-sm"
                  >
                    {activity}
                  </span>
                ))}
        ...
        <section className="bg-stone-900 py-20">
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-2">
              <div className="relative aspect-[4/3] overflow-hidden rounded-[2rem] border border-stone-800 shadow-xl shadow-black/40">
                <Image
                  src="/coa.jpg"
          ...
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="mt-14 grid gap-x-12 gap-y-10 sm:grid-cols-2">
              {features.map((f, i) => (
                <div
                  key={f.title}
                  className="flex gap-5 border-t border-stone-800 pt-6"
                >
        ...
        {/* Fees */}
        <section id="fees" className="bg-stone-900 py-20">
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {fees.map((row) =>
                row.highlight ? (
                  ...
                  <div
                    key={row.grade}
                    className="flex flex-col rounded-3xl border border-stone-800 bg-stone-950 p-6 shadow-md shadow-black/30 transition-all hover:-translate-y-1 hover:border-yellow-500/30"
                  >
            ...
            <ul className="mx-auto mt-10 grid max-w-2xl gap-3 text-sm text-stone-400 sm:grid-cols-2">
              {[
        ...
        <section id="timings" className="py-20">
          <div className="mx-auto max-w-4xl px-6">
            ...
            <div className="mt-10 flex flex-col divide-y divide-stone-800 overflow-hidden rounded-[2rem] border border-stone-800 bg-stone-900 sm:flex-row sm:divide-x sm:divide-y-0">
              {[
                {
        ...
        {/* Contact */}
        <section id="contact" className="relative overflow-hidden bg-stone-900 py-20">
