        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-2xl px-6 py-16 text-center sm:py-20">
            ...
            <h1 className="mt-5 text-4xl font-extrabold tracking-tight text-stone-900 sm:text-5xl dark:text-white">
              Book a{" "}
              <span className="text-yellow-600">Demo Class</span>
            </h1>
        ...
        <section className="bg-yellow-50 py-16 dark:bg-stone-800">
          <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 lg:grid-cols-[3fr_2fr]">
            <div className="order-2 space-y-6 lg:order-1">
              <div className="relative aspect-[900/553] w-full overflow-hidden rounded-[2rem] border-4 border-white shadow-lg dark:border-stone-900">
                <Image
                  src="/onlineclass.png"
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                {trustPoints.map((p) => (
                  <div
                    key={p.text}
                    className="flex flex-col items-start gap-2 rounded-2xl bg-white p-4 shadow-md dark:bg-stone-900"
                  >
                    <span
            ...
            <form
              action={formAction}
              className="order-1 rounded-[2rem] bg-white p-6 shadow-lg lg:order-2 dark:bg-stone-900"
            >
            {formError && (
