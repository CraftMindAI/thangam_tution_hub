...
const inputClass =
  "mt-1.5 w-full rounded-xl border border-zinc-700 bg-zinc-950 px-3.5 py-2.5 text-sm text-white outline-none placeholder:text-zinc-500 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20";
    ...
    return (
      <div className="flex flex-1 flex-col bg-zinc-950 text-white">
        ...
        <main className="relative flex flex-1 items-center justify-center overflow-hidden px-6 py-16">
          ...
          <div className="relative w-full max-w-sm rounded-[2rem] border border-zinc-800 bg-zinc-900 p-8 text-center shadow-xl shadow-black/30">
            ...
            <Link
              href="/"
              className="mt-6 inline-flex items-center justify-center rounded-full bg-gradient-to-r from-yellow-300 to-yellow-500 px-6 py-2.5 text-sm font-semibold text-zinc-900 shadow-md transition-transform hover:scale-[1.02]"
            >
              Back to Home
            </Link>
          </div>
        ...
        <section className="bg-zinc-900 py-16">
          <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 lg:grid-cols-[3fr_2fr]">
            <div className="order-2 space-y-6 lg:order-1">
              <div className="relative aspect-[900/553] w-full overflow-hidden rounded-[2rem] border border-zinc-800 shadow-xl shadow-black/40">
                <Image
                  src="/onlineclass.png"
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                {trustPoints.map((p) => (
                  <div
                    key={p.text}
                    className="flex flex-col items-start gap-2 rounded-2xl border border-zinc-800 bg-zinc-950 p-4 shadow-md shadow-black/20"
                  >
                    <span
            ...
            <form
              action={formAction}
              className="order-1 rounded-[2rem] border border-zinc-800 bg-zinc-950 p-6 shadow-xl shadow-black/30 lg:order-2"
            >
            {formError && (
            ...
            <button
              type="submit"
              disabled={pending}
              className="mt-6 flex w-full items-center justify-center gap-1.5 rounded-full bg-gradient-to-r from-yellow-300 to-yellow-500 px-4 py-2.5 text-sm font-semibold text-zinc-900 shadow-md transition-transform hover:scale-[1.02] disabled:pointer-events-none disabled:opacity-60"
            >
