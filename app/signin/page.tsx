          ...
          >
            ...
            <div className="relative mt-1.5">
              <input
                ...
                required
                placeholder="••••••••"
                className="w-full rounded-xl border border-stone-200 bg-stone-50 px-3.5 py-2.5 pr-11 text-sm text-stone-900 outline-none placeholder:text-stone-400 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 dark:border-stone-700 dark:bg-stone-900 dark:text-white"
              />
              <button
                type="button"
