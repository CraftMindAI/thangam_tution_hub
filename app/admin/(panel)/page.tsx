...
import { BookOpen, Users, CalendarClock, Inbox } from "../../components/icons";
                ...
                >
                  <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400">
                      {r.contact_person_name} &middot; {r.followup_contact_number}
                    </p>
                  </div>
              ...
              {newRequests.slice(0, 5).map((r) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400">
                      Std {r.standard} &middot; {r.contact_person_name}
                    </p>
                  </div>
                  <span className="shrink-0 text-slate-600 dark:text-slate-400">
